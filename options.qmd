...
|                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | ```                                                                         |   |
+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-----------------------------------------------------------------------------+---+
| `journal`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | Fields that are used only for journal articles (`jou` mode).                |   |
| `volume`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |                                                                             |   |
...
# Document modes in typst

The `documentmode` field works in `apaquarto-typst` as well as `apaquarto-pdf`. All four modes are supported: `man` (manuscript), `jou` (journal, two columns), `doc` (a plain continuous document), and `stu` (student paper).

In `stu` mode the student-paper fields `course`, `professor`, `duedate`, and `note` are placed on the title page. In `jou` mode the journal metadata appears at the top of the article masthead: set the journal name as `journal: {title: "..."}` (Quarto reserves `journal` as an object), with top-level `volume`, `copyrightnotice`, and `copyrighttext`.

In typst `jou` and `doc` modes, figures and tables are placed in text by default (as they are in the equivalent `.pdf` output), while `man` and `stu` modes collect them at the end in the manuscript convention. Either default can be overridden with `floatsintext`: set it to `false` to move floats to the end, or `true` to keep them in text.
...
| `email` | The translation for "Email" in correspondence note | *Email* |
| `citation-masked-title` | The abbreviated translation for "Masked Title" in masked citations | *Masked Title* |
| `figure-table-note` | The translation for "Note" in table and figure notes | *Note* |
